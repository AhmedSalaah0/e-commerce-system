...
public class Main {
    public static void main(String[] args){
        ...
        Product Biscuits = new Product("Biscuits", 150.0, 20, ProductType.GROCERIES, ExpirationType.EXPIRABLE, LocalDate.of(2022, 12, 31), 700.0);
    ...
    for (int i = 0; i < productsToAdd.length; i++) {
            try {
                cartService.addItemToCart(productsToAdd[i], quantities[i]);
            }
